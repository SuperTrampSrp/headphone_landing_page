  ...
  return (
    <main className="bg-zinc-[#181C14] h-screen">
      <nav className="flex flex-row justify-between py-8 px-16 uppercase items-center">
        ...
        <div>
          <button className="bg-gradient-to-tr from-teal-500 to bg-cyan-950  w-32 text-slate-950 p-2 border border-none rounded-lg">Login</button>
        </div>
      </nav>
      <section className="flex">
        <div className="w-8/12 flex flex-col p-11 gap-2 bg-gradient-to-br from-yellow-400 to-teal-300 text-transparent bg-clip-text">
          ...
          <button className="p-3 bg-gradient-to-tr from-teal-500 to bg-cyan-950 w-32 mt-7 uppercase font-semibold border border-none rounded-lg text-white">read more</button>
        </div>
      ...
      <div className="flex px-11 gap-3">
        <div className="bg-gradient-to-r from-cyan-600 to-zinc-800 p-4 border border-none rounded-lg">
        ...
        <div className="bg-gradient-to-r from-teal-500 to-slate-800 p-4 border border-none rounded-lg">
